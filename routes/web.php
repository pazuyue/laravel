...
Route::group(['middleware' => ['checkPermission']], function () {
    ...
    Route::get('/user/useraddshow', 'User\UserController@userAddShow')->name('user-userAdd');
    Route::post('/user/useradd', 'User\UserController@userAdd')->name('user-userAdd');
    Route::get('/user/useredit/{id}', 'User\UserController@userEditShow')->name('user-userEdit');
    ...
    Route::get('/user/userrole/{id}', 'User\UserController@userRoleShow')->name('user-userRole');
    Route::put('/user/userrole', 'User\UserController@userRole')->name('user-userRole');
});
...
Route::get('/role/roleedit/{id}', 'Role\RoleController@roleEditShow')->name('role-roleEdit');
Route::put('/role/roleedit', 'Role\RoleController@roleEdit')->name('role-roleEdit');
Route::get('/role/roleaddshow', 'Role\RoleController@roleAddShow')->name('role-roleAdd');
Route::put('/role/roleadd', 'Role\RoleController@roleAdd')->name('role-roleAdd');
Route::get('/role/permissionrole/{id}', 'Role\RoleController@permissionRoleShow')->name('role-permissionRole');
...
Route::get('/permission/permissionadd', 'Permission\PermissionController@permissionAddShow')->name('permission-permissionAdd');
...
Route::get('/getfile', 'HomeController@getfile_to_db')->name('home');
